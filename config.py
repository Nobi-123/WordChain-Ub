...
# MongoDB setup
MONGO_URI = os.getenv("MONGO_URI", "mongodb+srv://user:pass@cluster0.mongodb.net/")
DB_NAME = os.getenv("DB_NAME", "TNC_WordChain")

WORDS_PATH = os.getenv("WORDS_PATH", "words.txt")
OWNER_ID = int(os.getenv("OWNER_ID", "8157752411"))
LOG_GROUP_ID = int(os.getenv("LOG_GROUP_ID", "-1001234567890"))  # replace with your log group
